...
class Contact extends Component { /* only class component can manage controlled froms, not functional components!! So change to class component */
    ...
    handleInputChange(event) { /*invoked whenever something's typed or changed in the form, to make the change visible to us onscreen */
    ...
    handleSubmit(event) {
        ...
        event.preventDefault(); /* can be used if we want to stay on the same page after submit */
    }
